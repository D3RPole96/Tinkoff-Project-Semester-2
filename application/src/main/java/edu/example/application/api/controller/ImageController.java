...
public class ImageController {
  ...
  public UploadImageResponse uploadImage(@RequestParam MultipartFile file,
    ...
    var multipartFile = new MultipartFileImplementation(file.getBytes(),
        authorUsername + "'s image",
        file.getContentType());

    return imageMapper
        .imageEntityToUploadImageResponse(
            imageService.uploadImageToUser(multipartFile, authorUsername)
        );
  }
